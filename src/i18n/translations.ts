export const translations = {
  de: {
    ...
    tailorFactsComplexity: 'Wir passen die Fakten an Ihre bevorzugte Komplexität an',
  ...
  fr: {
    ...
    choosePreferredLanguage: 'Choisissez votre langue préférée pour l\'application',
    languageDescription: 'Vous pouvez modifier cela plus tard dans les paramètres',

    // Onboarding - Difficulty
    chooseDifficultyLevel: 'Choisissez votre niveau de difficulté',
    tailorFactsComplexity: 'Nous adapterons les faits à votre complexité préférée',
  ...
  tr: {
    ...
    tailorFactsComplexity: 'Bilgileri tercih ettiğiniz karmaşıklığa göre uyarlayacağız',
