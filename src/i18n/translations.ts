export const translations = {
  de: {
    ...
    paywallFeatureOfflineSupport: 'Offline-Unterstützung',
    paywallFeatureOfflineDesc: 'Fakten jederzeit lesen, auch ohne Internet',
    paywallFeatureOfflineCombinedDesc: 'Fakten lesen und Trivia spielen, auch ohne Internet',
    paywallFeatureOfflineTrivia: 'Offline-Trivia',
    paywallFeatureOfflineTriviaDesc: 'Spiele Trivia auch ohne Internetverbindung',
    ...
    offlineGateTitle: 'Du bist offline',
    offlineGateDescription: 'Upgrade auf Premium für vollen Offline-Zugang',
    offlineGateCta: 'Premium holen',
  ...
  en: {
    ...
    paywallFeatureOfflineSupport: 'Offline Support',
    paywallFeatureOfflineDesc: 'Read facts anytime, even without internet',
    paywallFeatureOfflineCombinedDesc: 'Read facts and play trivia, even without internet',
    paywallFeatureOfflineTrivia: 'Offline Trivia',
    paywallFeatureOfflineTriviaDesc: 'Play trivia games even without internet',
    ...
    offlineGateTitle: "You're offline",
    offlineGateDescription: 'Upgrade to Premium for full offline access',
    offlineGateCta: 'Go Premium',
  ...
  es: {
    ...
    paywallFeatureOfflineSupport: 'Soporte sin conexión',
    paywallFeatureOfflineDesc: 'Lee datos en cualquier momento, incluso sin internet',
    paywallFeatureOfflineCombinedDesc: 'Lee datos y juega trivia, incluso sin internet',
    paywallFeatureOfflineTrivia: 'Trivia sin conexión',
    paywallFeatureOfflineTriviaDesc: 'Juega trivia incluso sin internet',
    ...
    offlineGateTitle: 'Estás sin conexión',
    offlineGateDescription: 'Actualiza a Premium para acceso completo sin conexión',
    offlineGateCta: 'Obtener Premium',
  ...
  fr: {
    ...
    paywallFeatureOfflineSupport: 'Mode hors ligne',
    paywallFeatureOfflineDesc: 'Lisez des faits à tout moment, même sans internet',
    paywallFeatureOfflineCombinedDesc: 'Lisez des faits et jouez au trivia, même sans internet',
    ...
    offlineGateTitle: 'Vous êtes hors ligne',
    offlineGateDescription: 'Passez à Premium pour un accès hors ligne complet',
    offlineGateCta: 'Passer Premium',
  ...
  ja: {
    ...
    paywallFeatureOfflineSupport: 'オフラインサポート',
    paywallFeatureOfflineDesc: 'インターネットがなくてもいつでも読める',
    paywallFeatureOfflineCombinedDesc: 'ネットなしでも記事を読んでトリビアをプレイ',
    paywallFeatureOfflineTrivia: 'オフライントリビア',
    paywallFeatureOfflineTriviaDesc: 'インターネットなしでもトリビアをプレイ',
    ...
    offlineGateTitle: 'オフラインです',
    offlineGateDescription: 'Premiumにアップグレードして完全なオフラインアクセスを',
    offlineGateCta: 'Premiumへ',
    paywallBestValue: 'お得',
  ...
  ko: {
    ...
    paywallFeatureOfflineSupport: '오프라인 지원',
    paywallFeatureOfflineDesc: '인터넷 없이도 언제든지 팩트를 읽으세요',
    paywallFeatureOfflineCombinedDesc: '인터넷 없이도 팩트를 읽고 트리비아를 즐기세요',
    paywallFeatureOfflineTrivia: '오프라인 트리비아',
    paywallFeatureOfflineTriviaDesc: '인터넷 없이도 트리비아를 즐기세요',
    ...
    offlineGateTitle: '오프라인 상태입니다',
    offlineGateDescription: 'Premium으로 업그레이드하여 완전한 오프라인 접근',
    offlineGateCta: 'Premium 시작',
  ...
  tr: {
    ...
    paywallFeatureOfflineSupport: 'Çevrimdışı Destek',
    paywallFeatureOfflineDesc: 'İnternet olmadan bile istediğin zaman oku',
    paywallFeatureOfflineCombinedDesc: 'İnternet olmadan bile oku ve trivia oyna',
    paywallFeatureOfflineTrivia: 'Çevrimdışı Trivia',
    paywallFeatureOfflineTriviaDesc: 'İnternet olmadan bile trivia oyna',
    ...
    offlineGateTitle: 'Çevrimdışısın',
    offlineGateDescription: "Tam çevrimdışı erişim için Premium'a yükselt",
    offlineGateCta: "Premium'a Geç",
  ...
  zh: {
    ...
    paywallFeatureOfflineSupport: '离线支持',
    paywallFeatureOfflineDesc: '随时阅读，即使没有网络',
    paywallFeatureOfflineCombinedDesc: '无网络也能阅读和玩问答',
    paywallFeatureOfflineTrivia: '离线问答',
    paywallFeatureOfflineTriviaDesc: '没有网络也能玩问答游戏',
    ...
    offlineGateDescription: '升级到Premium获取完整离线访问',
    offlineGateCta: '获取Premium',
