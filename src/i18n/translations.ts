export const translations = {
  de: {
    ...
    paywallFeaturePremiumCategoriesDesc: '10 Premium-Themen wie Finanzen, Kriminalität & Mythologie',
  ...
  en: {
    ...
    readingStatsTitle: 'Your Reading Journey',
    ...
    statsReadingBadgesSubtitle: 'Tap any badge to see your progress',
    ...
    statsOpenDetails: "Open details",
    statsOneFactOn: '%{count} fact on %{date}',
    statsManyFactsOn: '%{count} facts on %{date}',
    statsNoActivityOn: 'No activity on %{date}',
    statsHomeCardTitle: 'Your reading stats',
    statsHomeCardSubtitle: '%{count} today · %{streak}-day streak',
    statsHomeCardSubtitleNoStreak: '%{count} today',
