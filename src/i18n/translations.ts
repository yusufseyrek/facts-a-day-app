export const translations = {
  de: {
    ...
    settingsRemoveAds: 'Alle Werbung entfernen',
    settingsPremiumActive: 'Premium aktiv',
    settingsManageSubscription: 'Abo verwalten',
  ...
  en: {
    ...
    settingsRemoveAds: 'Remove all ads',
  ...
  es: {
    ...
    settingsRemoveAds: 'Eliminar todos los anuncios',
  ...
  fr: {
    ...
    settingsRemoveAds: 'Supprimer toutes les publicités',
  ...
  ja: {
    ...
    settingsRemoveAds: 'すべての広告を削除',
    settingsPremiumActive: 'プレミアム有効',
    settingsManageSubscription: 'サブスクリプション管理',
  ...
  tr: {
    ...
    settingsRemoveAds: 'Tüm reklamları kaldır',
    settingsPremiumActive: 'Premium Aktif',
    settingsManageSubscription: 'Aboneliği Yönet',
