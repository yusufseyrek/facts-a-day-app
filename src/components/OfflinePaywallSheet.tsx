 ...
 * The host conditionally mounts it, so `visible` stays true for its lifetime;
 * dismissible={false} keeps backdrop tap and Android back from closing it.
 */
export function OfflinePaywallSheet() {
  ...
  const dynamicStyles = useMemo(
    ...
    [radius, spacing, tc, featureIconSize, media, borderWidths]
  );

  return (
    <BottomSheetShell visible dismissible={false}>
