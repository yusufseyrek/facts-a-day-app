 ...
 *
 * Generated from /usr/share/zoneinfo/zone.tab (tzdb), plus legacy alias
 * names (Asia/Calcutta, Europe/Kiev, ...) resolved by identical-content
 * matching against canonical zones; ambiguous aliases are omitted.
 * Multi-country zones like Etc/* and UTC are deliberately absent.
 */
...
/** Country code for an IANA zone id, or null when unknown/ambiguous. */
