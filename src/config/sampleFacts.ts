...
export const sampleFacts: Record<SupportedLocale, SampleFact[]> = {
  ...
  de: [
    ...
    {
      title: 'Ein herzhaftes Käsegericht wurde so beliebt, dass es einen nationalen Feiertag erhielt',
      image: FOOD_IMAGE,
      category: 'Essen',
      categoryColor: FOOD_COLOR,
    },
  ...
  es: [
    ...
    {
      title: 'Algunos aviones de combate pueden volar más rápido que el sonido sin usar combustible extra',
      image: TECHNOLOGY_IMAGE,
      category: 'Tecnología',
      categoryColor: TECHNOLOGY_COLOR,
    },
  ...
  fr: [
    ...
    {
      title: "Un plat au fromage savoureux est devenu si populaire qu'il a obtenu sa fête nationale",
      image: FOOD_IMAGE,
      category: 'Cuisine',
      categoryColor: FOOD_COLOR,
    },
